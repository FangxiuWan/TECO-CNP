...
!(forcing_data,output_data,output_daily_mcmc,obs_TianTong,&
                    !&force_nhours,jforce,nobs,jobs,MCMC)
      USE FileSize
      IMPLICIT NONE
...
! M-H algorithm
	...
	!calculate the cost
!	WRITE(*,*)'out_put=',output_daily(:,1)
!	WRITE(*,*)'obs=',obs_TianTong(:,1)
...
!602                    !format((i7),",",14(f15.4,","))
    ...
    !WRITE(*,*)'isimu,upgraded,rejectnow',isimu,upgraded,rejectnow
