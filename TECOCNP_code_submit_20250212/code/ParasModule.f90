...
MODULE vars_site
    ...
    !   Read the initial file for simulations
        ...
        OPEN(112,file='../input/TianTongSpecificParameters_20250106.csv',status='old',ACTION='READ')
        ! Forcing data
        !OPEN(111,file='../input/ForTECOSpinup_2001_co2.txt',status='old',ACTION='READ')
        !OPEN(111,file='../input/TransientRun2002_2021_co2.txt',status='old',ACTION='READ')
        OPEN(111,file='../input/Forcing_RainChange_2021_co2.txt',status='old',ACTION='READ')
        ! Initial C pools, CN, CP ratios
        OPEN(113,file='../input/A_Initialstate_fromspinup_cnp.csv',status='old',ACTION='READ') 
        
        IF (MCMC .eq. 1)THEN
            OPEN(114,file='../input/Test_HourlyCFlux_2021_interpGPP.txt',status='old',ACTION='READ')    !Observed data for data assimilation
            OPEN(115,file='../input/mcmc_range_20250106.csv',status='old',ACTION='READ')
        ENDIF
...
!Fixed initial values
        ...
        !N_deposit=36.02*1000/10000/8760! kgN/ha/year to gN/m2/h   !wan- Zhu et al., 2016
...
!Paras read
        ...
        f_M2P      =    site_paras(49) 
        f_S2M      =    site_paras(50)
        f_S2P      =    site_paras(51) !0.05!
        f_P2M      =    site_paras(52)
        ! an higher value to do the spin-up
        QPlab      =    1.0!0.91!3.8!site_paras(53) 
        QNminer    =    7.6!4.30!7.12!7.6!site_paras(54)
        s_w_min    =    site_paras(55)
        rate_maxN  =    site_paras(60)
        rate_maxP  =    site_paras(61)*2*3
